                ...
                <div className='p-5 rounded-lg shadow-lg gap-5 h-96 w-96 flex flex-col items-center justify-center bg-sky-700'>
                    ...
                    <form>
                        ...
                        <div className="flex items-center justify-between pb-6">
                            ...
                            <button
                            type="button"
                            className="inline-block shadow-lg rounded border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-danger-600 focus:border-danger-600 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
                            >
                            Regisztráció
                            </button>
                        </div>
